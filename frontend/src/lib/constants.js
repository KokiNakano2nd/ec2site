...
export const ORDER_STATUSES = [
  ...
  { value: "cancelled",       label: "キャンセル済み", color: "#7c85a8", bg: "rgba(124,133,168,0.1)", border: "rgba(124,133,168,0.2)" },
  { value: "return_requested", label: "返品申請中",   color: "#f59e0b", bg: "rgba(245,158,11,0.1)",  border: "rgba(245,158,11,0.2)" },
  { value: "returned",        label: "返品完了",     color: "#ff6b6b", bg: "rgba(255,107,107,0.1)", border: "rgba(255,107,107,0.2)" },
];
