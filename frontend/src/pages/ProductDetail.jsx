...
export function ProductDetail({
  ...
  return (
    <div style={{ animation: "fadeUp 0.3s ease" }}>
      <button className="btn-back" onClick={onBack} style={{ marginBottom: 32 }}>
        ← 商品一覧に戻る
      </button>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "start" }}>
        ...
        <div style={{ paddingTop: 8 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
            ...
            <button
              ...
              style={{
                ...
                gap: 6,
                fontSize: 13,
                color: favProductIds.has(productId) ? "#ff6b6b" : C.sec,
                fontWeight: 600,
          ...
          >
            <div style={{ fontSize: 38, fontWeight: 800, letterSpacing: "-1.5px", color: C.text, marginBottom: 4 }}>
              ¥{fmt(product.price)}
            </div>
            {product.stock === 0 ? (
              ...
              <div style={{ fontSize: 13, color: C.muted }}>
                在庫残り
                <span style={{ color: product.stock <= 7 ? C.red : C.text, fontWeight: 600, marginLeft: 4 }}>
                  {product.stock}個
                </span>
                {product.stock <= 7 && (
                  <span style={{ color: C.red, marginLeft: 6, fontSize: 11 }}>（残りわずか）</span>
                )}
              </div>
            )}
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
            ...
            >
              ...
              <span style={{ minWidth: 44, textAlign: "center", fontSize: 16, fontWeight: 700, color: C.text }}>
                {quantity}
              </span>
              <button
                className="qty-btn"
