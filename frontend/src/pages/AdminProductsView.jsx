              ...
              editingId === product.id ? (
                ...
                <Fragment key={product.id}>
                  ...
                  >
                    ...
                    <td
                      style={{ padding: "16px 20px", textAlign: "right", fontSize: 15, fontWeight: 700, color: C.text }}
                    >
                      ¥{fmt(product.price)}
                    </td>
                    <td
                      style={{
                        ...
                        textAlign: "right",
                        fontSize: 14,
                        color: isLowStock(product) ? C.red : C.sec,
                      }}
                    >
                      {product.stock}
                      {isLowStock(product) && (
                    ...
                    <td style={{ padding: "16px 20px", textAlign: "right", fontSize: 13, color: C.muted }}>
                    ...
                    <td style={{ padding: "16px 20px", textAlign: "right" }}>
                      <div style={{ display: "flex", justifyContent: "flex-end", gap: 6 }}>
                        <button
                          className="btn-surface"
                          onClick={() =>
                            managingImagesFor === product.id ? setManagingImagesFor(null) : openImageManager(product)
                          }
                          style={{
                            padding: "7px 14px",
                            fontSize: 13,
                            color: managingImagesFor === product.id ? C.accent : undefined,
                          }}
                        >
                          画像
                        </button>
