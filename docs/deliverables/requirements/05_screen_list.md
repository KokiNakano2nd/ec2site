...
| 画面ID | 画面名 | 概要 | 主なアクター | 元になったドキュメント |
|---|---|---|---|---|
| S-104 | 売上ダッシュボード画面 | 売上サマリー・日別売上推移・売れ筋商品・カテゴリ別売上を確認する。低在庫の商品がある場合はアラートセクションに一覧表示する(2026-07-12追加、US-024)(`view === "admin-dashboard"`、`AdminDashboardView`) | 管理者 | US-019, US-024 |
