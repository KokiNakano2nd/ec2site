...
| アーキテクチャ | [概要](deliverables/architecture/01_architecture_overview.md)、[デプロイ](deliverables/architecture/02_deployment_design.md)、[セキュリティ・プライバシー](deliverables/architecture/03_security_privacy_design.md)、[開発環境ToBe](deliverables/architecture/04_development_environment_tobe.md)、[CI/CD・DevSecOps ToBe](deliverables/architecture/05_cicd_devsecops_tobe.md)、[ADR一覧](deliverables/architecture/adr/README.md) |
