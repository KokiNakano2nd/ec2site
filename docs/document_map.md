...
| architecture | `cicd_devsecops_tobe_template.md` | `05_cicd_devsecops_tobe.md` |
...
- 当時はPlaywright E2EのCI組み込みを見送ったが、2026-07-15にChromiumのPR smokeを追加した。全件・クロスブラウザの定期CIは`05_cicd_devsecops_tobe.md`のPhase 2で扱う
